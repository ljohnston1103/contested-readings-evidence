    ...
    <div className="grid gap-4 md:grid-cols-2">
      {previous ? (
        <Link
          ...
          className="rounded-[1.75rem] border border-ink-200 bg-white/75 p-5 shadow-card transition hover:-translate-y-1 hover:border-archive-gold/60 dark:border-white/10 dark:bg-white/[0.05]"
        >
      ...
      {next && (
        <Link
          ...
          className="rounded-[1.75rem] border border-ink-200 bg-white/75 p-5 text-right shadow-card transition hover:-translate-y-1 hover:border-archive-gold/60 dark:border-white/10 dark:bg-white/[0.05]"
        >
