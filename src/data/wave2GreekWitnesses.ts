    ...
    additions: [
      {
        ...
        note: "Omits the added fulfillment clause; this is the f13 exception recorded in the apparatus.",
      },
      {
        siglum: "828",
        direction: "AGAINST_KJV",
    ...
    additions: [
      {
        ...
        direction: "AGAINST_KJV",
        relationship: "related",
        note: "Aggregate apparatus record for the Greek witnesses that omit the added fulfillment clause; not one manuscript.",
        aggregate: true,
      },
    ],
  },
  "luke-24-6:0": {
    additions: [
      ...
      },
      {
        ...
        direction: "FOR_KJV",
        relationship: "exact",
        note: "Aggregate record for the other extant Greek witnesses reported as including the clause; not one manuscript.",
        aggregate: true,
      },
    ],
  },
    ...
    additions: [
      {
        ...
        relationship: "related",
        note: "Aggregate apparatus record for the remaining non-lacunose Greek witnesses reading ξύλου (“tree”); not one manuscript.",
        aggregate: true,
      },
    ],
  },
...
export const wave2PrintedWitnesses: Readonly<Record<string, Witness[]>> = {
  ...
  "ephesians-3-9": [
    printedWitness(
      ...
      1516,
      1894,
      "Print κοινωνία (“fellowship”) in this unit; this is an aggregate printed-edition tradition, not manuscript evidence.",
      "unit-1",
  ...
  "revelation-1-11": [
    printedWitness(
      ...
      1516,
      1894,
      "Print the full Alpha/Omega expansion represented in the KJV; this is a printed tradition, not early manuscript evidence.",
      "primary",
