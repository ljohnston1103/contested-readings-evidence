...
const versionRows: readonly VersionRow[] = [
  ...
  ["vulgate-st", "Stuttgart Vulgate critical text", "AD 1969–2007 editions", 1969, 2007, "printed-edition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ["vulgate-ww", "Wordsworth–White Vulgate edition", "AD 1889–1954", 1889, 1954, "printed-edition", true, PALMER_REVELATION, PALMER_REVELATION_URL],

  ["syriac-tradition", "Syriac traditions", "Fourth–seventh centuries (aggregate traditions)", 301, 700, "version-tradition", true, WILLKER_MATTHEW, WILLKER_MATTHEW_URL],
  ["syriac-peshitta", "Syriac Peshitta", "Early fifth century", 401, 450, "version-tradition", true, WILLKER_MATTHEW, WILLKER_MATTHEW_URL],
  ["syriac-harklean", "Syriac Harklean", "AD 615–616", 615, 616, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ["syriac-philoxenian", "Syriac Philoxenian", "AD 507–508", 507, 508, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ...
  ["palestinian-syriac", "Palestinian Syriac", "Sixth–eighth centuries", 501, 800, "version-tradition", true, WILLKER_MATTHEW, WILLKER_MATTHEW_URL],
  ["syriac-diatessaron", "Syriac Diatessaron tradition", "Late second century (composition c. AD 170)", 165, 180, "version-tradition", true, WILLKER_MATTHEW, WILLKER_MATTHEW_URL, "This dates the Diatessaron tradition, not Ephrem's later surviving commentary manuscript."],

  ["coptic-tradition", "Coptic traditions", "Third–fifteenth centuries (aggregate traditions)", 201, 1500, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ["sahidic", "Sahidic Coptic", "Third–eleventh centuries (tradition and cited manuscripts)", 201, 1100, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ["bohairic", "Bohairic Coptic", "Fourth–fifteenth centuries (aggregate tradition)", 301, 1500, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ...
  ["faiyumic", "Faiyumic Coptic", "Seventh–eighth century", 601, 800, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],

  ["armenian", "Armenian version", "Fifth–sixteenth centuries (aggregate tradition)", 401, 1600, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ...
  ["georgian", "Georgian version", "Fifth–sixteenth centuries (aggregate tradition)", 401, 1600, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ["georgian-ii", "Georgian-II recension", "Ninth–tenth centuries", 801, 1000, "version-tradition", true, WILLKER_MATTHEW, WILLKER_MATTHEW_URL],
  ["gothic", "Gothic version", "Mid-fourth century (c. AD 350)", 340, 380, "version-tradition", true, WILLKER_MATTHEW, WILLKER_MATTHEW_URL],
  ["ethiopic", "Ethiopic version", "About AD 500 (translation tradition; surviving witnesses are later)", 475, 525, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL, "Palmer notes that the continuous-text Revelation manuscripts preserving the earliest Ethiopic form are fourteenth–sixteenth century."],
  ...
  ["slavonic", "Slavonic version", "Ninth–sixteenth centuries (aggregate tradition)", 801, 1600, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ["slavonic-b", "Slavonic-b", "Ninth–sixteenth centuries (versional strand)", 801, 1600, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
  ["arabic", "Arabic versions", "Seventh–sixteenth centuries (aggregate traditions)", 601, 1600, "version-tradition", true, PALMER_REVELATION, PALMER_REVELATION_URL],
